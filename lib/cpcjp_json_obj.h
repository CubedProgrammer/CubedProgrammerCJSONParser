...
void cpcjp_insert_num_into_list(struct cpcjp_json_val*,double);
void cpcjp_insert_bool_into_list(struct cpcjp_json_val*,int);
void cpcjp_insert_str_into_list(struct cpcjp_json_val*,const char*);
void cpcjp_insert_val_into_list(struct cpcjp_json_val*,struct cpcjp_json_val*);
void cpcjp_insert_null_into_list(struct cpcjp_json_val*);
